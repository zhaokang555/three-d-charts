export {init as initBarChart} from './bar-chart/BarChart';
export {init as initBarChart2Args} from './bar-chart/BarChrat2Args';
...
export {chinaProvinceList} from './Constant';
