 ...
 */
export const getPositionByLonLat = (lon, lat, r = earthRadius) => {
 ...
 */
export const getLonLatByPosition = (position) => {
 ...
 * @return {THREE.Vector3}
 */
export const getControlPointPosition = (scene, fromCoordinates, toCoordinates) => {
 ...
 * @param r: number
 */
export const greatCircleDistance = (fromPosition, toPosition, r = earthRadius) => {
