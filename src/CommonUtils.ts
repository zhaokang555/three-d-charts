 ...
 */
export const getRenderer = (container, camera) => {
 ...
 */
export const addControlsToCamera = (camera, renderer, options = {}) => {
 ...
 * @return {function}
 */
export const initHighlightCube = (scene, camera) => {
 ...
 */
export const _setTextMeshScaleTo2ByBottomCenter = (mesh) => {
    if (mesh) {
 ...
 * @param mesh: THREE.Mesh
 */
export const _setTextMeshScaleTo1ByBottomCenter = (mesh) => {
    if (mesh) {
